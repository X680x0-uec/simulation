...
public class ResultControler : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        string dLine1 = $"Dead Attackers:{nbsp}{deadA}{nbsp}Times";
        string dLine2 = $"Dead Defencers:{nbsp}{deadB}{nbsp}Times";
        string dLine3 = $"Dead Archers:{nbsp}{deadC}{nbsp}Times";

        string sLine1 = $"Spawned Attackers:{nbsp}{spawnA}{nbsp}Times";
        string sLine2 = $"Spawned Defencers:{nbsp}{spawnB}{nbsp}Times";
        string sLine3 = $"Spawned Archers:{nbsp}{spawnC}{nbsp}Times";
